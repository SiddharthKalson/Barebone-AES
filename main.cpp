...
{
    printf("======================STARTING============================");
    unsigned char message[] = "This is a test message for the AES";
    ...
    int orignalLen = strlen((const char*)message);
    int lenOfPaddedMessage = orignalLen;
    ...
    {
        if(i >= orignalLen) paddedMessage[i] = 0;
